...
def main():
    ...
    page = st.sidebar.radio('Go to', ['Home', 'Predict','Power BI Dashboard', 'Model Development','Model Flow Chart'])
    ...
    # Prediction page
        ...
        Total_spend = st.number_input('Total_spend')
        Customer_Since_Years = st.number_input('Customer_Since_Years')
        Education_encode = st.number_input('Education_encode')
